...
void MPU9250::getMres() {
  ...
  // 14 bit resolution (0) and 16 bit resolution (1)
    case MFS_14BITS:
          mRes = 10.*4912./8190.; // Proper scale to return milliGauss (sur 14 bits donc /2^13) ~ 10*0.6uT/LSB
          break;
    case MFS_16BITS:
          mRes = 10.*4912./32760.0; // Proper scale to return milliGauss (sur 16 bits donc /2^15)
          break;
  }
}
...
void MPU9250::getGres() {
  ...
  // 250 DPS (00), 500 DPS (01), 1000 DPS (10), and 2000 DPS  (11). 
    ...
    case GFS_250DPS:
          gRes = 250.0/32768.0; //pas de conversion du gyro sur 16 bits ==> 32768 = 2^(16-1)
          break;
    case GFS_500DPS:
          gRes = 500.0/32768.0;
          break;
...
void MPU9250::getAres() {
  ...
  // 2 Gs (00), 4 Gs (01), 8 Gs (10), and 16 Gs  (11). 
        // Here's a bit of an algorith to calculate DPS/(ADC tick) based on that 2-bit value:
    case AFS_2G:
          aRes = 2.0/32768.0; //pas de conversion de l'accelero sur 16 bits
          break;
    case AFS_4G:
          aRes = 4.0/32768.0;
          break;
